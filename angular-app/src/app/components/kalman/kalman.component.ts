...
@Component({
  selector: 'app-kalman',
  templateUrl: './kalman.component.html',
  styleUrls: ['./kalman.component.css'],
  animations: [
    trigger(
      'enterAnimationLeft', [
        transition(':enter', [
...
export class KalmanComponent implements OnInit {
  uploader: FileUploader = new FileUploader(
    {
      url: 'http://127.0.0.1:8000/kalman_info/', removeAfterUpload: false, autoUpload: true
    }
  );
  visible: boolean;
  visible1: boolean;
  ...
  getSomeInfo() {
    this.api.getKalman().subscribe(
      (data: any[]) => {
        console.log(data);
        // console.log(JSON.parse(data[0]));
        this.base64Image = "data:image/png;base64, " +  data[0].reg_image;
