...
@Component({
  selector: 'app-weight-mov-avg',
  templateUrl: './weight-mov-avg.component.html',
  styleUrls: ['./weight-mov-avg.component.css'],
  animations: [
    trigger(
      'enterAnimationLeft', [
        transition(':enter', [
...
export class WeightMovAvgComponent implements OnInit {

  uploader: FileUploader = new FileUploader(
    {
      url: 'http://127.0.0.1:8000/weighted_ma_info/', removeAfterUpload: false, autoUpload: true
       }
    );
  visible = false;
  visible1 = false;
  ...
  hover2: boolean;
    ...
    {
      "title": { "text": "Running moving averages" },
  ...
  getSomeInfo() {
    this.api.getWeightMovingAverages().subscribe(
     (data: any[]) => {
           this.info = data;
